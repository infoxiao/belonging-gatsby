...
This is the project site for WiTNY Ambient Belonging Project.

## Usage

```bash
# Installation with `git clone`
git clone witny-belong git@github.com:cornelltech/witny-belong.git
cd witny-belong
yarn install
...
-   Xiao Ma ([@infoxiao](https://twitter.com/infoxiao))
-   [Shuqi Yang](http://shuqi-yang.squarespace.com/)
-   Ananya Paul
